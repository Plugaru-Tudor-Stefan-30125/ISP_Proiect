...
import aut.utcluj.isp.ex4.EquipmentAlreadyProvidedException;
...
public class Equipment {
    ...
    public void provideEquipmentToUser(final String owner, final LocalDateTime providedDate) {
        equipmentHistory.addEquipmentHistory(owner, aut.utcluj.isp.ex4.Operation.PROVIDE, providedDate);
    }
